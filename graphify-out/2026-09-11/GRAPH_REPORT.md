...
## Corpus Check
- 13 files · ~18,171 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 40 nodes · 28 edges · 17 communities (13 shown, 4 thin omitted)
...
Cohesion: 0.40
Nodes (4): Hubungi Saya, Keahlian Utama, Saat Tidak Ngoding, Siapa Saya
...
## Knowledge Gaps
- **21 isolated node(s):** `name`, `private`, `type`, `packageManager`, `build` (+16 more)
